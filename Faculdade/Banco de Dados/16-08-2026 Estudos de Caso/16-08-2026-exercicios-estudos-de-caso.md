...
- `Entrevistador` **N:N** `Municipio`
  - Um entrevistador pode percorrer vários municípios.
  - Um município pode ser percorrido por vários entrevistadores.

- `Municipio` **1:N** `Domicilio`
  - Um municipio tem vários domicílios.
  - Um domicilio está em um municipio.

- `Domicilio` **1:N** `Pessoa`
  - Um domicilio pode ter várias pessoas.
  - Uma pessoa está em um domicilio.

- `Domicilio` **1:1** `Particular`
  - Um domicilio particular é apenas um domicilio.

- `Domicilio` **1:1** `Coletivo`
  - Um domicilio coletivo é apenas um domicilio.
...
-- Tabela associativa para resolver o N:N Entrevistador x Municipio
CREATE TABLE IF NOT EXISTS entrevistador_municipio (
    id_entrevistador INT NOT NULL,
    id_municipio INT NOT NULL,
    PRIMARY KEY (id_entrevistador, id_municipio),
...
CREATE TABLE IF NOT EXISTS domicilio_particular (
    id_domicilio INT PRIMARY KEY,
    quant_televisoes INT NOT NULL,
    quant_radios INT NOT NULL,
